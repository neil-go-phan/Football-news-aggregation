...
func (_m *MockSchedulesServices) ClearMatchURLsOnDay() {
	_m.Called()
}

// MockSchedulesServices_ClearMatchURLsOnDay_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ClearMatchURLsOnDay'
type MockSchedulesServices_ClearMatchURLsOnDay_Call struct {
	*mock.Call
}

// ClearMatchURLsOnDay is a helper method to define mock.On call
func (_e *MockSchedulesServices_Expecter) ClearMatchURLsOnDay() *MockSchedulesServices_ClearMatchURLsOnDay_Call {
	return &MockSchedulesServices_ClearMatchURLsOnDay_Call{Call: _e.mock.On("ClearMatchURLsOnDay")}
}

func (_c *MockSchedulesServices_ClearMatchURLsOnDay_Call) Run(run func()) *MockSchedulesServices_ClearMatchURLsOnDay_Call {
...
func (_c *MockSchedulesServices_ClearMatchURLsOnDay_Call) Return() *MockSchedulesServices_ClearMatchURLsOnDay_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockSchedulesServices_ClearMatchURLsOnDay_Call) RunAndReturn(run func()) *MockSchedulesServices_ClearMatchURLsOnDay_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockSchedulesServices) GetAllScheduleLeagueOnDay(date time.Time) (entities.ScheduleOnDay, error) {
	ret := _m.Called(date)
...
func (_c *MockSchedulesServices_GetAllScheduleLeagueOnDay_Call) Return(_a0 entities.ScheduleOnDay, _a1 error) *MockSchedulesServices_GetAllScheduleLeagueOnDay_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSchedulesServices_GetAllScheduleLeagueOnDay_Call) RunAndReturn(run func(time.Time) (entities.ScheduleOnDay, error)) *MockSchedulesServices_GetAllScheduleLeagueOnDay_Call {
	_c.Call.Return(run)
	return _c
}

// GetMatchURLsOnDay provides a mock function with given fields:
func (_m *MockSchedulesServices) GetMatchURLsOnDay() entities.MatchURLsOnDay {
	ret := _m.Called()
...
// MockSchedulesServices_GetMatchURLsOnDay_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMatchURLsOnDay'
type MockSchedulesServices_GetMatchURLsOnDay_Call struct {
	*mock.Call
}

// GetMatchURLsOnDay is a helper method to define mock.On call
func (_e *MockSchedulesServices_Expecter) GetMatchURLsOnDay() *MockSchedulesServices_GetMatchURLsOnDay_Call {
	return &MockSchedulesServices_GetMatchURLsOnDay_Call{Call: _e.mock.On("GetMatchURLsOnDay")}
}

func (_c *MockSchedulesServices_GetMatchURLsOnDay_Call) Run(run func()) *MockSchedulesServices_GetMatchURLsOnDay_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSchedulesServices_GetMatchURLsOnDay_Call) Return(_a0 entities.MatchURLsOnDay) *MockSchedulesServices_GetMatchURLsOnDay_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSchedulesServices_GetMatchURLsOnDay_Call) RunAndReturn(run func() entities.MatchURLsOnDay) *MockSchedulesServices_GetMatchURLsOnDay_Call {
	_c.Call.Return(run)
	return _c
}

// GetMatchURLsOnTime provides a mock function with given fields:
func (_m *MockSchedulesServices) GetMatchURLsOnTime() entities.MatchURLsWithTimeOnDay {
	ret := _m.Called()
...
func (_c *MockSchedulesServices_GetMatchURLsOnTime_Call) Return(_a0 entities.MatchURLsWithTimeOnDay) *MockSchedulesServices_GetMatchURLsOnTime_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockSchedulesServices_GetMatchURLsOnTime_Call) RunAndReturn(run func() entities.MatchURLsWithTimeOnDay) *MockSchedulesServices_GetMatchURLsOnTime_Call {
	_c.Call.Return(run)
	return _c
}

// GetScheduleLeagueOnDay provides a mock function with given fields: date, league
func (_m *MockSchedulesServices) GetScheduleLeagueOnDay(date time.Time, league string) (entities.ScheduleOnDay, error) {
...
func (_c *MockSchedulesServices_GetScheduleLeagueOnDay_Call) Return(_a0 entities.ScheduleOnDay, _a1 error) *MockSchedulesServices_GetScheduleLeagueOnDay_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSchedulesServices_GetScheduleLeagueOnDay_Call) RunAndReturn(run func(time.Time, string) (entities.ScheduleOnDay, error)) *MockSchedulesServices_GetScheduleLeagueOnDay_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockSchedulesServices_SignalMatchDetailServiceToCrawl_Call) Run(run func(matchURLs entities.MatchURLsOnDay)) *MockSchedulesServices_SignalMatchDetailServiceToCrawl_Call {
	_c.Call.Run(func(args mock.Arguments) {
