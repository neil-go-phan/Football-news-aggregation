...
func (_m *MockArticleRepository) SearchArticlesTagsAndKeyword(keyword string, formatedTags []string, from int) ([]entities.Article, error) {
	ret := _m.Called(keyword, formatedTags, from)

	var r0 []entities.Article
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []string, int) ([]entities.Article, error)); ok {
...
func (_c *MockArticleRepository_SearchArticlesTagsAndKeyword_Call) Return(_a0 []entities.Article, _a1 error) *MockArticleRepository_SearchArticlesTagsAndKeyword_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockArticleRepository_SearchArticlesTagsAndKeyword_Call) RunAndReturn(run func(string, []string, int) ([]entities.Article, error)) *MockArticleRepository_SearchArticlesTagsAndKeyword_Call {
	_c.Call.Return(run)
	return _c
}
